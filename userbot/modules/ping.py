...
async def redis(pong):
    ...
    await xx.edit(
        f"**{ALIVE_NAME}**        \n"
        f"**➭ᴋᴇᴄᴇᴘᴀᴛᴀɴ : ** '%sms'  \n"
        f"**➭ʙʀᴀɴᴄʜ : ** 'SKYLA-USERBOT` \n" % (duration)
    )


@skyla_cmd(pattern="lping$")
async def redis(pong):
    """For .ping command, ping the userbot from any chat."""
