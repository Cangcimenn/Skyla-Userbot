...
@skyla_cmd(pattern="promote(?:\\s|$)([\\s\\S]*)")
...
async def promote(event):
    ...
    eventskyla = await edit_or_reply(event, "`Promosikan Pengguna Sebagai Admin... Mohon Menunggu`")
    ...
    try:
        ...
        await edit_delete(eventskyla, "`Berhasil Menambahkan Pengguna Ini Sebagai Admin!`")

    # If Telethon spit BadRequestError, assume
    # we don't have Promote permission
    except BadRequestError:
        return await eventgrovy.edit(NO_PERM)
...
@skyla_cmd(pattern="demote(?:\\s|$)([\\s\\S]*)")
...
async def demote(event):
    ...
    eventskyla = await edit_or_reply(event, "`Sedang Melepas Admin...`")
    ...
    # Assume we don't have permission to demote
        ...
        return await eventgrovy.edit(NO_PERM)
    await edit_delete(eventgrovy, "`Berhasil Melepas Pengguna Ini Sebagai Admin!`")
...
async def ban(bon):
    ...
    skyla = await edit_or_reply(bon, "`Melakukan Banned!`")
...
async def nothanos(unbon):
    ...
    skyla = await edit_or_reply(unbon, "`Sedang Melakukan Unban...`")
    ...
    try:
        ...
        await edit_delete(skyla, "```Berhasil Melepas Ban Pengguna!```")
        ...
        await edit_delete(skyla, "`Sepertinya Terjadi Kesalahan!`")


@skyla_cmd(pattern="mute(?: |$)(.*)")
...
async def spider(spdr):
    ...
    skyla = await edit_or_reply(spdr, "`Sedang melakukan Mute...`")
    ...
    if user.id == self_user.id:
        return await edit_or_reply(grovy,
                                   "`Tangan Terlalu Pendek, Tidak Bisa Membisukan Diri Sendiri...\n(ヘ･_･)ヘ┳━┳`"
                                   )

    # If everything goes well, do announcing and mute
    await skyla.edit("`Telah Dibisukan!`")
    if mute(spdr.chat_id, user.id) is False:
        return await skyla.edit("`Pengguna Sudah Dibisukan!`")
    else:
        try:
            ...
            if reason:
                await skyla.edit(f"**Pengguna Telah Dibisukan!**\n**Alasan:** `{reason}`")
            else:
                await skyla.edit("`Telah Dibisukan!`")
            ...
            return await edit_delete(grovy, "`Terjadi Kesalahan!`")


@skyla_cmd(pattern="unmute(?: |$)(.*)")
...
async def unmoot(unmot):
    ...
    skyla = await edit_or_reply(unmot, "```Melakukan Unmute...```")
    ...
    if unmute(unmot.chat_id, user.id) is False:
        ...
        try:
            ...
            await edit_delete(skyla, "```Berhasil Melakukan Unmute! Pengguna Sudah Tidak Dibisukan```")
        except UserIdInvalidError:
            return await edit_delete(skyla, "`Terjadi Kesalahan!`")
...
async def ungmoot(un_gmute):
    ...
    skyla = await edit_or_reply(un_gmute, "`Sedang melakukan membuka Global Mute...`")
    ...
    await skyla.edit("```Membuka Global Mute Pengguna...```")

    if ungmute(user.id) is False:
        await skyla.edit("`Pengguna Sedang Tidak Di Gmute!`")
    else:
...
async def gspider(gspdr):
    ...
    skyla = await edit_or_reply(gspdr, "`Processing...`")
    user, reason = await get_user_from_event(gspdr)
    if not user:
        return

    # If pass, inform and start gmuting
    await skyla.edit("`Pengguna Berhasil Dibisukan!`")
    if gmute(user.id) is False:
        await edit_delete(gspdr, "`Kesalahan! Pengguna Sudah Dibisukan.`")
    else:
        if reason:
            await skyla.edit(f"**Dibisukan Secara Global!**\n**Alasan:** `{reason}`")
        else:
