    ...
    if chat.id != OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**Users**: {mention}\
                        ...
                        \n**Forward**: True\
                        \n\n**Powered by**: [Skyla-Userbot](https://github.com/Cangcimenn/Skyla-Userbot)"
            buttons=[
                (
...
async def infor(event):
        await tgbot.send_message(
            event.chat_id,
            message=f"**Channel**: [Skyla](t.me/Xgrovy_id)\n**Github**: [Skyla-Userbot](https://github.com/Cangcimenn/Skyla-Userbot)\n**Deploy**: [Heroku](https://telegram.dog/XTZ_HerokuBot?start=U2VuZGlBcC9Sb3NlLVVzZXJib3QgbWFzdGVy)",
            buttons=[
                [
                    custom.Button.inline(
                        "ᴄʟᴏꜱᴇ",
