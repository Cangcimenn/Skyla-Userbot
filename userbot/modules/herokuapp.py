...
@skyla_cmd(pattern=r"^.(get|del) var(?: |$)(\w*)")
...
@skyla_cmd(pattern=r"^.set var (\w*) ([\s\S]*)")
...
CMD_HELP.update({"herokuapp": "𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}usage`"
